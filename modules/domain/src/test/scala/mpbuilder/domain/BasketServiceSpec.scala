    ...
    suite("calculating total")(
      test("calculates total for single item") {
        ...
        assertTrue(
          ...
          calculation.subtotal == Money("82.50"),
          calculation.total == Money("82.50"),
          calculation.currency == Currency.USD,
        )
      },
      test("calculates total for single item with multiple quantity") {
        ...
        assertTrue(
          calculation.items.size == 1,
          calculation.subtotal == Money("247.50"),
          calculation.total == Money("247.50"),
        )
      },
      test("calculates total for multiple items") {
        ...
        assertTrue(
          ...
          calculation.subtotal == Money("136.50"),
          calculation.total == Money("136.50"),
        )
      },
    ),
