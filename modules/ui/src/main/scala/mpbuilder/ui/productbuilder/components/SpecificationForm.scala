      ...
      div(
        ...
        div(
          ...
          div(
            ...
            HelpInfo(lang.map {
              case Language.En => "How the pages are held together. Saddle stitch (stapled) is cheapest for thin booklets. Perfect binding (glued spine) is for thicker publications. Plastic o-binding and metal wire allow the book to lay flat when open."
              case Language.Cs => "Způsob spojení stránek. Sešitová vazba (sešitá) je nejlevnější pro tenké brožury. Lepená vazba (lepený hřbet) je pro silnější publikace. Plastová kroužková a drátěná vazba umožňují, aby kniha ležela naplocho při otevření."
            }),
          ),
          div(
            cls := "form-group__control",
