  ...
  private def componentRoleLabel(role: ComponentRole, lang: Language): String =
    role match
      ...
      case ComponentRole.FrontCover => lang match
        case Language.En => "Front Cover (optional)"
        case Language.Cs => "Přední obálka (volitelná)"
      case ComponentRole.BackCover => lang match
        case Language.En => "Back Cover (optional)"
        case Language.Cs => "Zadní obálka (volitelná)"
      ...
      case ComponentRole.Binding => lang match
        case Language.En => "Binding Material"
        case Language.Cs => "Materiál vazby"
