...
| [changelog/2026-05-09-material-sheet-size-validation.md](changelog/2026-05-09-material-sheet-size-validation.md) | Add `maxSheetSize` to Material; orientation-aware sheet size validation in ConfigurationValidator |
